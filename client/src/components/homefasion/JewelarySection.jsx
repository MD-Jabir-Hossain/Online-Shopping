...
const JewelarySection = () => {
    const jewelary = products.filter(product => product.category === "jewelery");
    ...
    return (
        <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8 border rounded-md mt-8 sm:mt-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
                {jewelary.slice(0, 3).map((product) => (
            ...
            {/* Featured Product */}
            {jewelary.slice(3, 4).map((product) => (
...
export default JewelarySection;